...
export type CommentsQuery = { __typename?: 'Query', comments?: { __typename?: 'PaginatedComments', totalCount: number, cursor: any, hasMore: boolean, paginatedComments: Array<{ __typename?: 'Comment', numUsersLiked?: number | null | undefined, voteStatus: number, id: string, content: string, createdAt: string, updatedAt: string, user: { __typename?: 'User', id: string, firstName: string, lastName: string, image_url?: string | null | undefined } }> } | null | undefined };
...
export const VoteCommentDocument = gql`
    mutation VoteComment($action: String!, $type: VoteType!, $voteCommentCommentId2: ID!) {
